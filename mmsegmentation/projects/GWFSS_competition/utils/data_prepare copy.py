...
# Source directories
source_root = Path("/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/GWFSS_competition/data/synth_datasetAll")
image_dir = source_root / "img_dir"
mask_dir = source_root / "cls_dir"

# Target directories
target_root = Path("/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/GWFSS_competition/data/synth_datasetcorrected")
...
for domain, files in domain_groups.items():
    if len(files) != 11:
        print(f"⚠️  Domain {domain} has {len(files)} images (expected 11). Skipping.")
        continue
...
print(f"\n✅ Split complete. Total: {total_train} train, {total_test} test images.")
