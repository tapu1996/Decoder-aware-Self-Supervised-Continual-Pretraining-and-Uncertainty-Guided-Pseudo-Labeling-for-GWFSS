...
_base_ = [
    './gwfss_dataloaderf2.py', 'models/convnext_uppernetv2_huge.py',
...
checkpoint_path = "/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/GWFSS_competition/model/convnextv2_huge_1k_224_fcmae_modified.pth"
model = dict(
    data_preprocessor=data_preprocessor,
