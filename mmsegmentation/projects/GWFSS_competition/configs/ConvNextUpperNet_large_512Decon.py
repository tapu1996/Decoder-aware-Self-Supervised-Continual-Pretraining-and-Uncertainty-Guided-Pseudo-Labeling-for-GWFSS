...
_base_ = [
    './gwfss_dataloaderf0Pseudo.py', 'models/convnext_uppernet_large.py',
...
checkpoint_path = "/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/GWFSS_competition/model/deconMLCOntinual/deconmlCOntinual_enc.pth"
model = dict(
    data_preprocessor=data_preprocessor,
