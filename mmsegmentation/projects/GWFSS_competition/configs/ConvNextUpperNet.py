...
_base_ = [
    './gwfss_dataloader.py', 'models/convnext_uppernet.py',
...
checkpoint_path = "/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/GWFSS_competition/model/slotcon_continual_convnext_large.pth"
model = dict(
    data_preprocessor=data_preprocessor,
