...
_base_ = [
    './gwfss_dataloader_larger768.py', 'models/convnext_uppernet_large.py',
...
checkpoint_path = "/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/GWFSS_competition/model/convnext_imagetnet_large_1k.pth"
model = dict(
    data_preprocessor=data_preprocessor,
