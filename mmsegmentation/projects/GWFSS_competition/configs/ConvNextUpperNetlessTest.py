...
_base_ = [
    './gwfss_dataloader10test.py', 'models/convnext_uppernet.py',
    'mmseg::_base_/default_runtime.py',
    'schedulers/new_40k.py'
]
...
checkpoint_path = "/home/tapotosh/projects/def-farma/tapotosh/DenseSSL_root/mmsegmentation/projects/Fundus/refuge/backbones/SlotConBaseConvNextSmallGWFSS/encoderSlotConBaseConvNextSmallGWFSS.pth"
model = dict(
    data_preprocessor=data_preprocessor,
