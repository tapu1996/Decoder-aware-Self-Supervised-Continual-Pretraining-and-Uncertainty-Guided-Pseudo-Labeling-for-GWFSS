...
if __name__=='__main__':
    ...
    labels =[]
    with torch.no_grad():
        for data,label in tqdm(dataloader, desc='Feature extracting', leave=False, disable=False):
            ...
            feature_to_work_on = feature[0]#feature["p2"]
...
plt.title('Base-t-SNE-layer3: Colored by COCO Category ID')
plt.colorbar(scatter)
plt.savefig('BaseLayer3.png')    
